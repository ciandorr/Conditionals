...
%	...
%	\aitem
%	If no superheroes work at the Daily Planet and Superman is trying to rescue us, everyone at the Daily Planet is cheering.
%	\aitem
%	If everyone at the Daily Planet is cheering, then no superheroes work at the Daily Planet and Superman is trying to rescue us.  
%	\aitem
...
%has been captured by an enemy who could only be defeated by a superhero, and realises that any employees of the Daily Planet who aren't actively involved are are watching the episode on TV and cheering or not depending on whether they think the enemy will be defeated.  Then each of the above sentences seems true.  Given Leibniz's Law, 
\begin{prop}
...
% Quantifier domain restriction can also explain the felicity of sentences like the following:
% \begin{prop}
%     \nitem
%     You'd have to be an idiot to believe of someone that you think is a reporter that they can fly, while still believing that all reporters are unexceptional.   
% \end{prop}
